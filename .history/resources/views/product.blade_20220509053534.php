                ...
                <div class="container">
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            <a class="product-gallery-item active" href="#" data-image="{{ asset('/images/products/single/1.jpg') }}" data-zoom-image="assets/images/products/single/1-big.jpg">
                                                <img src="{{ asset('/images/molla/Armchairs/ATHENA_CHAIR_WITH_RECLINING_BACK_FUNCTION1.jpg') }}" alt="product side">
                                            </a>
                    ...
                    <div class="product-details-tab">
                        <ul class="nav nav-pills justify-content-center" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="product-info-link" data-toggle="tab" href="#product-info-tab" role="tab" aria-controls="product-info-tab" aria-selected="false">Details</a>
                            </li>
                            {{-- <li class="nav-item">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="product-info-tab" role="tabpanel" aria-labelledby="product-info-link">
                                <div class="product-desc-content">
                                    ...
                                    <span style="font-size: 20; font-weight:bold ">Width: </span><span>{{$dimension->width}}</span><br/>
                                    <span style="font-size: 20; font-weight:bold ">Height: </span><span>{{$dimension->height}}</span><br/>
                                    <span style="font-size: 20; font-weight:bold ">Weight: </span><span>{{$dimension->weight}}</span><br/>
                                    <span style="font-size: 20; font-weight:bold ">Length: </span><span>{{$dimension->length}}</span><br/>
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                        ...
                        <div class="product product-7 text-center">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="{{ url('product') }}">Brown paperbag waist <br>pencil skirt</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $60.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">

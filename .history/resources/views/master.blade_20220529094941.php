                                        ...
                                        <form action="{{ Route('auth.register.action') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select type="text" class="form-control" id="register-gender"
                                                    ...
                                                    <option value="Nam" selected></option>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    ...
                                                    <select name="register-city" class="form-control"  required ></select>
            
                                                </div><!-- End .col-sm-6 -->
                                                <div class="col-sm-4">
                                                    <label>Distric / County *</label>
                                                    <select  name="register-district" class="form-control" required ></select>
                                                </div><!-- End .col-sm-6 -->
                                                <div class="col-sm-4">
            
                                                    <label>Ward / County *</label>
                                                    <select name="register-ward" class="form-control"  required ></select>
                                                </div><!-- End .col-sm-6 -->
                                            </div><!-- End .row -->

    ...
    <div class="content-wrapper">
        ...
        <section>
            <div class="container-fluid px-5 d-none" id="add-form">
                ...
                <div class="row ">
                    <div class="col-md-12">
                        <form class="card card-danger" method="POST" action="{{ route('admin.product.add') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                        ...
                                        {{-- <div class="form-group col-12 clearfix" name="add_product_image">
                                            @if ($loop->first)
                                                <div class="col-8"> <input type="file" name="product_image"
                                                        id="{{ $value->id }}" accept="image/*" required>
                                                </div>
                                            @else
                                                <div class="col-8"> <input type="file" name="product_imagehihi[]"

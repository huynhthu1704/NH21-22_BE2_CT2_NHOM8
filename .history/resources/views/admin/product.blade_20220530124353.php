            ...
            <div class="row ">
                <div class="col-md-12">
                    <form id="form-edit" class="card card-danger" method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <input hidden type="text" class="form-control" id="edit-id" name="id"
                                        ...
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td><button class="btn btn-warning"
                                                        onclick="remove({{ $product->id }})">Remove</button></td>
                                            </tr>
                                        @endforeach
                                    <tbody>
                                </table>
        ...
        function edit(sender, id) {
            ...
            xhr.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    edit.querySelector('input[name="product_name"]').value = obj['product_name'];
                    edit.querySelector('input[name="product_quantity"]').value = obj['quantity'];
                    edit.querySelector('input[name="product_price"]').value = obj['price'];

                    edit.querySelector('input[name="product_width"]').value = obj['width'];
                    edit.querySelector('input[name="product_height"]').value = obj['height'];
                    edit.querySelector('input[name="product_weight"]').value = obj['weight'];
                    edit.querySelector('input[name="product_length"]').value = obj['length'];
                    ...
                    edit.querySelector('textarea[name="product_description"]').value = obj['description'];
                    for (var i = 0; i < selectCategory.options.length; i++) {
                        if (selectCategory.options[i].value === obj['cate']) {
                            selectCategory.selectedIndex = i;
                            break;
                        }
                    }
                    for (var i = 0; i < selectBrand.options.length; i++) {
                        if (selectBrand.options[i].value === position) {

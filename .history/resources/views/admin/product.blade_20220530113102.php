...
@section('main')
    ...
    <script>
        ...
        function edit(sender, id) {
            ...
            const name = sender.dataset.productName;
            const quantity = sender.dataset.productQuantity;
            const price = sender.dataset.productQuantity;
            const category = sender.dataset.productQuantity;
            const brand = sender.dataset.productQuantity;
            const width = sender.dataset.productQuantity;
            const height = sender.dataset.productQuantity;
            const weight = sender.dataset.productQuantity;
            const length = sender.dataset.productQuantity;

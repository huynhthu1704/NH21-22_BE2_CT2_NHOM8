        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 ">
                        <button onclick="addBanner()" style="padding: 10; background: yellow" class="float-sm-right btn btn-"><a style="font-size: 30; color: white" href="#add">Add banner</a></button>

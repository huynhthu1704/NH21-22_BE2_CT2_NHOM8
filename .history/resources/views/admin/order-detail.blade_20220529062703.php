                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    @endphp
                                    <h5 class="customer-info">Name: {{ $fullName }}</h5>
                                    <p class="customer-info">Address: {{ $customer->address }}</p>
                                    <p class="customer-info">Phone: {{ $customer->phone_number }}</p>
                                    <p class="customer-info">Email: {{ $customer->email }}</p>
                                </div>
                                <!-- /.card-header -->

                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    @php
                                        ...
                                        $address = $customer->city." - ".$customer->district." - ".$customer->address;
                                    @endphp
                                    <h5>Name: {{ $fullName }}</h5>
                                ...
                                <div class="cart-footer p-3">
                                    ...
                                    <h5>Delivery fee: {{ number_format($order->shipping_fee) }}</h5>
                                    <h5 style="font-weight: bold">Total: {{ number_format($order->total) }}</h5>
                                </div>
                            </div>
                            <!-- /.card -->
                        </div>

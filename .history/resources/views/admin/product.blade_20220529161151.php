                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" style="width: 100%;" tabindex="-1"
                                                aria-hidden="true" name="product-category" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Brand</label>
                                            <select class="form-control" style="width: 100%;" tabindex="-1"
                                                aria-hidden="true" name="product-brand" required>
                                                @foreach ($brands as $key => $value)
                                                    @if ($key === 0)
                                                        <option value="{{ $value['id'] }}" selected="selected">{{ $value['brand_name'] }}</option>
                                                    @else
                                ...
                                <div class="row">
                                    ...
                                    @foreach ($colors as $key => $value)
                                        <div class="form-group col-12 clearfix" name="product_color">
                                            <div class="col-4">
                                                <div>
                                                    @if ($loop->first)
                                                        <input type="checkbox" id="chkbox{{ $value->id }}"
                                                            name="product-color" value="{{ $value->id }}" onclick="check(this)"
                                                            checked required>
                                                    @else
                                                        <input type="checkbox" id="chkbox{{ $value->id }}"
                                                            name="product-color" value="{{ $value->id }}"  onclick="check(this)">
                                            ...
                                            @if ($loop->first)
                                                <div class="col-8"> <input type="file"
                                                        name="product-image" id="{{ $value->id }}"
                                                        multiple required>
                                                </div>
                                            @else
                                                <div class="col-8"> <input type="file"
                                    ...
                                    <div class="form-group col-12">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Width</label>
                                                    <input type="number" min="10" name="product-width"
                                                        class="form-control" step="50" value="1" min="1">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Height</label>
                                                    <input type="number" min="10" name="product-height"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Weight</label>
                                                    <input type="number" min="10" name="product-weight"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Length</label>
                                                    <input type="number" min="10" name="product-length"
                                                        class="form-control" step="10" value="0" min="1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="actions" class="row">
                                    <div class="col-lg-6">
                                        <div class="btn-group w-100">
                                            <button type="submit" class="btn btn-success col" onclick="add()">

...
{{-- {{dd($categories)}} --}}
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 ">
                        <button onclick="addBanner()" class="float-sm-right btn btn-warning"><a style="font-size: 30; color: white">Add banner</a></button>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <form class="card card-danger" method="POST" action="{{route('admin.banner.add')}}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            {{-- <div class="form-group">
                                <label for="add-title">ID</label>
                                <input type="text" class="form-control" id="edit-title" name="banner_id"
                                    placeholder="Enter title" required value="hihi">
                            </div>
                            <div class="form-group">
                                <input type="text"  class="form-control" id="add-id"  name="banner_id" value="">
                            </div> --}}
                            <div class="form-group">
        ...
        <div class="container-fluid px-5 d-none" id="edit-form">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="card card-danger" method="POST" action="<?php echo "<script>let id = document.querySelector('#edit-form').querySelector('input[name='banner_id']').value; alert(id)</script>" ?>" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @method("put")
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-success" onclick="editBanner({{$value['id']}})"><a style="text-decoration: none">Edit</a></button></td>
    ...
    <!-- jQuery -->
    <script src="{{ asset('css/admin/plugins/jquery/jquery.min.js') }}"></>
    <!-- Bootstrap 4 -->
    ...
    <script>
        ...
        const editBanner = (id) => {
          ...
          document.querySelector('#edit-form').querySelector('input[name="banner_id"]').value = id;
        }
        const cancel= () => {

...
@section('main')
    ...
    <script>
        ...
        function edit(sender, id) {
            ...
            const category = sender.dataset.endDay;
            const brand = sender.dataset.endDay;
            const width = sender.dataset.endDay;
            const height = sender.dataset.endDay;
            const weight = sender.dataset.endDay;
            const length = sender.dataset.endDay;

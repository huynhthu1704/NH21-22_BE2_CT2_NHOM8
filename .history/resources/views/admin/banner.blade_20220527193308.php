...
@section('main')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 ">
                        <button onclick="addBanner()" class="float-sm-right btn btn-warning">Add banner</button>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <form id="form-edit" class="card card-danger" method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="card-footer">
                            <div id="actions" class="row">
                                <div class="col-lg-6">
                                    <div class="btn-group w-100">
                                        <button id="btn-edit" class="btn btn-success col" onclick="editBanner()">
        ...
        <div class="container-fluid px-5 d-none" id="remove-form">
            <!-- /.content -->
            <div class="row">
                <div class="col-md-12">
                    @php
                    ...
                    <form id="form-remove" class="card card-danger" method="POST" action="" enctype="multipart/form-data">
                        ...
                        @method('delete')
                        <div class="card-body">
                            <input hidden type="text" class="form-control" id="remove_id" name="remove_id"
                                placeholder="Enter title" required value="">
                        </div>
                    </form>
                    <!-- /.card -->
                                    ...
                                    <tbody>
                                        @foreach ($banners as $key => $value)
                                            <tr>
                                                ...
                                                <td><button class="btn btn-warning" onclick="">Remove</button></td>
                                            </tr>
                                        @endforeach
                                    <tbody>
                                </table>
    ...
    <script>
        ...
        function editBanner() {
            ...
            const action = "{{ url('admin/banner') }}/" + id;
            edit.action = action;
...
const remove() {
            const id = edit.querySelector('input[id="remove-id"]').value;
            const action = "{{ url('admin/banner') }}/" + id;
            edit.action = action;
            console.log(edit.action);

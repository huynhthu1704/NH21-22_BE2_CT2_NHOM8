        ...
        <div class="container-fluid px-5 d-none" id="edit-form">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="card card-danger" method="POST" action="{{url("admin/banner/"<script>document.querySelector('#edit-form').querySelector('input[name='banner_id']').value'")}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @method("put")

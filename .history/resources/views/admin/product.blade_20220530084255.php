    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid px-5 d-none" id="add-form">
            ...
            <div class="container-fluid px-5" id="remove-form">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form id="form-remove" class="card card-danger" method="POST" action=""
                            enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @method('delete')
                        </form>
                                        ...
                                        <tbody>
                                            @foreach ($products as $product)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p
                                                            style="height: 50%; overflow-y: scroll; text-overflow: ellipsis;">
                                                            {{ $product->description }}</p>
                                                    </td>
                                                    <td><button class="btn btn-success"
                                                            onclick="switchToEdit(1)">Edit</button>
                                                    </td>

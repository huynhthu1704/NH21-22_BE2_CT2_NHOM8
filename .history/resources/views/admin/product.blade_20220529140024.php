                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <label class="form-label col-12">Colors</label>
                                        ...
                                        <div class="form-group col-12 clearfix" name="product_color">
                                            <div class="col-4"> <div class="icheck-primary d-inline">
                                                @if ($loop->first)
                                                    <input type="checkbox" id="chkbox{{ $value->id }}" checked>
                                                @else
                                            ...
                                            <div class="col-8"> <input type="file" name="pro-image-{{ $value->id }}"
                                                id="pro-image-{{ $value->id }}" multiple></div>
                                ...
                                <div class="row ">
                                    ...
                                    @foreach ($colors as $color)
                                        <div class="form-group" name="image-{{ $color->id }}">

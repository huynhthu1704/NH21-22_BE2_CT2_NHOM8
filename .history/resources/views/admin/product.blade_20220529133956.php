                            ...
                            <div class="card-body">
                                ...
                                <div class="row ml-1">
                                    ...
                                    <div class="form-group clearfix" name="product_color">
                                        ...
                                        <div style="margin-right: 20 !important" class="icheck-primary d-inline">
                                            <input type="checkbox" id="checkbox{{$color->id}}" name="checkbox{{$color->id}}" value="1" checked>
                                            <label for="den">
                                                {{$color->color_name}}
                                            </label>
                                        </div>
                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($products as $product)
                                            <tr>
                                                <td>{{ $product->id }}</td>
                                                <td><a href="{{route('detail', $product->id)}}">{{ $product->product_name }}</a></td>

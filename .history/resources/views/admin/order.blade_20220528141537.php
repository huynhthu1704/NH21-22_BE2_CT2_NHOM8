                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @endphp
                                            <td><span style="color :{{$color}}">{{$status}}</span><button class="btn btn-warning" onclick="confirm({{$value['id']}})"><span style="color :{{$color}}">{{$status}}</span></button></td>
                                            <td><button class="btn btn-success">View detail</button></td>
                                        </tr>
                                        @endforeach
                                    <tbody>
                                    </table>

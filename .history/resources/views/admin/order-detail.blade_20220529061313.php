                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    @php
                                        $orderController = App\Http\Controllers\Admin\AdminOrderController;
                                    ...
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        @endphp
                                            @foreach ($orderItems as $orderItem)
                                               ...
                                               @endphp
                                                    <td><img width="40" height="40" src="{{ asset('images/products/'.$category->category_name.'/'. $img1)}}" alt="">{{ $product->product_name }}</td>

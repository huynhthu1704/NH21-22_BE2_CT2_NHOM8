...
{{-- {{dd($categories)}} --}}
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-success" data-position="{{$value['position']}}" data-category="{{$value['category_id']}}" data-category="{{$value['title']}}" data-banner-title="{{$value['title']}}" onclick="edit(this,{{$value['id']}})"><a style="text-decoration: none">Edit</a></button></td>
    ...
    <script>
        ...
        function edit (sender,id) {
          ...
          const selectCategory = edit.querySelector('input[name="category"]')
          const selectPosition = edit.querySelector('input[name="position"]')
          selectCategory.options.forEach(opt => {

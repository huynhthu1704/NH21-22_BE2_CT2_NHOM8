                                    ...
                                    <div class="form-group col-12 clearfix" name="product_color">
                                        @foreach ($colors as $key => $value)
                                            ...
                                            <div class="icheck-primary d-inline">
                                                @if ($key == array_key_first($colors))
                                                <input type="checkbox" id="chkbox{{ $color->id }}" check>
                                                @else
                                               @endif
                                ...
                                <div class="row ">
                                    <label class="form-label col-12">Images</label>
                                        ...
                                        <div class="form-group" name="image-{{$color->id}}">
                                            <input type="file" name="pro-image-{{$color->id}}" id="pro-image-{{$color->id}}" multiple hidden>
                                        </div>
                                        @endforeach

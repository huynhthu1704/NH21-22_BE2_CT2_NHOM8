...
@section('main')
    ...
    <script>
        ...
        function edit(sender, id) {
            ...
            edit.querySelector('input[name="product-name"]').value = name;
            edit.querySelector('input[name="product-quantity"]').value = quantity;
            edit.querySelector('input[name="product-price"]').value = price;

            edit.querySelector('input[name="width"]').value = width;
            edit.querySelector('input[name="height"]').value = height;
            edit.querySelector('input[name="weight"]').value = iweight;
            edit.querySelector('input[name="length"]').value = length;
            edit.querySelector('textarea[name="product-description"]').value = description;
        }

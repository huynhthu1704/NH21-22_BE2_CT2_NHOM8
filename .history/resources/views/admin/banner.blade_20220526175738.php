...
{{-- {{dd($categories)}} --}}
            ...
            <div class="row">
                <div class="col-md-12">
                    @php
                        // $id = 
                    @endphp
                    <form class="card card-danger" method="POST" action="{{url('admin/banner/'.(isset($_POST['id']) ? $_POST['id'] : ""))}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @method("put")
    ...
    <script>
        ...
        const editBanner = (id) => {
            ...
            const inputId = document.querySelector('#edit-form').querySelector('input[name="product-id"]');
            inputId.value = id
        }
        const cancel= () => {

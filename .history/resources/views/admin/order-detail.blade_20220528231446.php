                                ...
                                <div class="card-body -responsive p-0">
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            $product = new App\Http\Controllers\Admin\AdminProductController;
                                        @endphp
                                            @foreach ($orderItems as $orderItem)
                                               
                                                    <td><img width="40" height="40" src="{{ asset('images/products/'.$product->getProduct( $orderItem->product->product_name) )}}" alt="">{{ $orderItem->product->product_name }}</td>

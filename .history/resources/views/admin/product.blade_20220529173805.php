...
@section('main')
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1000" name="product_price" class="form-control"
                                                step="10000" value="100000" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    @foreach ($colors as $key => $value)
                                                ...
                                                <div>
                                                    @if ($loop->first)
                                                        <input type="checkbox" id="chkbox{{ $value->id }}"
                                                            name="product_color[]" value="{{ $value->id }}" onclick="check(this)"
                                                            checked required>
                                                    @else
                                                        <input type="checkbox" id="chkbox{{ $value->id }}"
                                                            name="product_color[]" value="{{ $value->id }}"  onclick="check(this)">
                                        ...
                                        <div class="form-group col-6 clearfix" name="add_product_color">
                                            @if ($loop->first)
                                                <div class="col-8"> <input type="file"
                                                        name="product_image" id="{{ $value->id }}"  accept="image/*"
                                                         required>
                                                </div>
                                            @else
                                                <div class="col-8"> <input type="file"
                                                        name="product_imagehihi[]" id="{{ $value->id }}"  accept="image/*"
                                                        multiple hidden>
                                                </div>
                                            @endif
                                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="card card-danger">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Quantity</label>
                                        <textarea id="summernote2" name="product_description">
                        ...
                        {{-- <input type="file" hidden multiple name="product_image" accept="image/*" id="input-file"> --}}
                        <div class="card-footer">
                            <div id="actions" class="row">
                                <div class="col-lg-6">
                                    <div class="btn-group w-100">
    ...
    <script>
        ...
        const switchToEdit = (id) => {
            ...
            const inputId = edit.querySelector('input[name="product_id"]');
            inputId.value = id
        }

...
{{-- {{dd($categories)}} --}}
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 ">
                        <button onclick="addBanner()" class="float-sm-right btn btn-warning"><a style="font-size: 30; color: white" href="#add">Add banner</a></button>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    @php
                        // $id = 
                    @endphp
                    <form class="card card-danger" method="POST" action="{{url('admin/banner/1')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @method("put")
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-success" data-banner-title="{{$value['title']}}" onclick="editBanner({{$value['id']}})"><a style="text-decoration: none">Edit</a></button></td>
    ...
    <script>
        ...
        function edit (id) {
            ...
            const title = this.dataset.bannerTitle
          ...
          document.querySelector('#edit-form').querySelector('input[name="name"]').value = title;
        }
        const cancel= () => {

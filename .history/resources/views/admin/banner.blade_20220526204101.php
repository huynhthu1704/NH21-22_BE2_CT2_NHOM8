        ...
        <div class="container-fluid px-5 d-none" id="edit-form">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="card card-danger" method="POST" action="<?php echo "<script>document.querySelector('#edit-form').querySelector('input[name='banner_id']').value</script>" ?>" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @method("put")

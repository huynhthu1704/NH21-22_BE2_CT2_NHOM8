...
@section('main')
                                        ...
                                        <div class="form-group col-12 clearfix" name="product_color">
                                                ...
                                                <div>
                                                    @if ($loop->first)
                                                        <input type="checkbox" id="chkbox{{ $value->id }}"
                                                            name="chkbox{{ $value->id }}"  value={{$value->id}} checked>
                                                    @else
                                                        <input type="checkbox" id="chkbox{{ $value->id }}"
                                                            name="chkbox{{ $value->id }}"  value={{$value->id}}>
                                                    @endif
                                                    <label for="chkbox{{ $value->id }}">
                                                        {{ $value->color_name }}
                                                    </label>
                                                </div>
                                            </div>
                                            @if ($loop->first)
                                                <div class="col-8"> <input type="file"
                                                        name="pro-image-{{ $value->id }}"
                                                        id="{{ $value->id }}" multiple>
                                                </div>
                                            @else
                                                <div class="col-8"> <input type="file"
                                                        name="pro-image-{{ $value->id }}"
                                                        id="{{ $value->id }}" multiple hidden>
                                                </div>
                                            @endif
                                        </div>
                                    @endforeach
    ...
    <script>
       function check(chkbox) {
                if (this.checked) {
                    alert(chkbox.target.value);
                   const input = document.getElementById(chkbox.target.value);
                } else {

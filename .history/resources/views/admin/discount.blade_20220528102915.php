...
{{-- {{dd($categories)}} --}}
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-success"
                                                ...
                                                data-start-day="{{ $value['start_at'] }}"
                                                data-end-day="{{ $value['finish_at'] }}"
    ...
    <script type="text/javascript">
        ...
        function edit(sender, id) {
            ...
            const title = sender.dataset.value;
            ...
            edit.querySelector('input[name="startDay"]').value = title;
            edit.querySelector('input[name="endDay"]').value = content;
        ...
        const remove = (id) => {
            const result = confirm("Do you want to delete this banner");
            if (result) {

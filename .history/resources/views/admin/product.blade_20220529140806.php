                                    ...
                                    @foreach ($colors as $key => $value)
                                        <div class="form-group col-12 clearfix" name="product_color">
                                            <div class="col-4">
                                                <div>
                                                    @if ($loop->first)
                                                        <input type="checkbox" id="chkbox{{ $value->id }}" name="chkbox{{ $value->id }}" checked>
                                                    @else
                                                        <input type="checkbox" id="chkbox{{ $value->id }}" name="chkbox{{ $value->id }}">
                                                    @endif
                                            ...
                                            @if ($loop->first)
                                                <div class="col-8"> <input type="file"
                                                        ...
                                                        id="pro-image-{{ $value->id }}" multiple>
                                                </div>
                                            @else
                                                <div class="col-8"> <input type="file"
                                                        name="pro-image-{{ $value->id }}"
                                                        id="pro-image-{{ $value->id }}" multiple hidden>
                                                </div>
                                            @endif

                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-success" data-category="{{$value['title']}}" data-category="{{$value['title']}}" data-banner-title="{{$value['title']}}" onclick="edit(this,{{$value['id']}})"><a style="text-decoration: none">Edit</a></button></td>

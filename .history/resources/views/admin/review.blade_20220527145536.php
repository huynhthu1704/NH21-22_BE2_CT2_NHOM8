                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body -responsive p-0">
                                <table style="width: 100% !important" class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Username</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 40%"><p style="overflow-y: scroll; height: 50px; text-overflow: ellipsis">{{$value['content']}}</p></td>
                                            <td>
                                            @php

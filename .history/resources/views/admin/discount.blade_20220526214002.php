                    ...
                    <form class="card card-danger" method="POST" action="{{route('admin.banner.add')}}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <input type="text"  class="form-control" id="add-id"  name="discount_id" value="">
                            </div>
                            <div class="form-group">
                                <label for="add-title">Value</label>
                                <input type="text" class="form-control" id="add-value" name="value"

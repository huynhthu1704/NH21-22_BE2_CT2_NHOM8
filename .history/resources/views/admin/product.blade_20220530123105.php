...
// description
            ...
            //        edit.querySelector('input[name="id"]').value = obj['product_name'];
            // edit.querySelector('input[name="product_name"]').value =  obj['product_name'];
            // edit.querySelector('input[name="product_quantity"]').value =  obj['id'];
            // edit.querySelector('input[name="product_price"]').value =  obj['id'];

            // edit.querySelector('input[name="product_width"]').value =  obj['id'];
            // edit.querySelector('input[name="product_height"]').value =  obj['id'];
            // edit.querySelector('input[name="product_weight"]').value =  obj['id'];
            // edit.querySelector('input[name="product_length"]').value =  obj['id'];
            // edit.querySelector('textarea[name="product_description"]').value =  obj['id'];
                }
            }
            // Sending our request 
            xhr.send();

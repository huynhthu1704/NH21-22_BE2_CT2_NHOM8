        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 ">
                        <button onclick="addBanner()" style="padding: 10; background: yellow" class="float-sm-right btn btn-warning"><a style="font-size: 30; color: white" href="#add">Add banner</a></button>

                        <ol class="breadcrumb float-sm-right">
                            <li onclick="addBanner()" style="padding: 10; background: yellow" class="breadcrumb-item"><a style="font-size: 30; color: white" href="#add">Add banner</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card-footer">
                            <div id="actions" class="row">
                                <div class="ms-auto col-lg-12">
                                    <button type="button" class="btn btn-primary mr-4 mb-4"
                                    style="margin-left: auto; display: block;">
                                    <i class="fas fa-upload"></i>
                                    <span>Cancel banner</span>
                                </button>
...
<a id="editBanner" href="#"></a>
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-success" onclick="switchToEdit({{$value['id']}})"><a style="text-decoration: none" href="#editBanner">Edit</a></button></td>
    ...
    <script>
         const addBanner = () => {
            ...
            // const inputId = edit.querySelector('input[name="banner-id"]');
            // inputId.value = id
        }
        const switchToEdit = (id = -1) => {
            document.querySelector('#add-form').classList.toggle('d-none');

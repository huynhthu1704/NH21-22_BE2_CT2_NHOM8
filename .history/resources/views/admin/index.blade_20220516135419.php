...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/admin/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('css/admin/icheck-bootstrap/icheck-bootstrap.min.css') }}">
  <!-- JQVMap -->
...
<!-- AdminLTE App -->
<script src="{{ asset('css/admi/js/adminlte.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{ asset('css/admi/js/demo.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('css/admi/js/pages/dashboard.js"></script>
</body>
</html>

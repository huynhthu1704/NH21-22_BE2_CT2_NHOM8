...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('../../public/css/images/icons/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="../../public/css/images/icons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="../../public/css/images/icons/favicon-16x16.png">
    <link rel="manifest" href="../../public/css/images/icons/site.html">
    <link rel="mask-icon" href="../../public/css/images/icons/safari-pinned-tab.svg" color="#666666">
    <link rel="shortcut icon" href="../../public/css/images/icons/favicon.ico">
    <meta name="apple-mobile-web-app-title" content="Molla">
    <meta name="application-name" content="Molla">
    <meta name="msapplication-TileColor" content="#cc9966">
    <meta name="msapplication-config" content="../../public/css/images/icons/browserconfig.xml">
...
<body>
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget widget-about">
	            				<img src="../../public/images/logo.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		...
	        		<figure class="footer-payments">
	        			<img src="../../public/images/payments.png" alt="Payment methods" width="272" height="20">
    ...
    <script src="../../public/js/jquery.hoverIntent.min.js"></script>

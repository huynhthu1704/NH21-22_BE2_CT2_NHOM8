                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" src="{{ asset('/images/products/single/1.jpg') }}" data-zoom-image="assets/images/products/single/1-big.jpg" alt="product image">
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            ...
                                            <a class="product-gallery-item" href="#" data-image="{{ asset('/images/products/single/3.jpg') }}" data-zoom-image="assets/images/products/single/3-big.jpg">

...
@section('content')
        ...
        <main class="main">
                            ...
                            <div class="intro-slider-container slider-container-ratio slider-container-1 mb-2 mb-lg-0">
                                <div class="intro-slider intro-slider-1 owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl" data-owl-options='{
                                    ...
                                    <div class="intro-slide">
                                        <figure class="slide-image">
                                            <picture>
                                                <source media="(max-width: 480px)" srcset=" {{ asset('/images/slider/slide-2-480w.jpg') }}">
                        ...
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-11 text-center">
                                <figure class="{{ asset('product-media') }}">
                                    <a href="product.html">
                                        <img src="{{ asset('/images/demos/demo-2/products/product-1-1.jpg') }}" alt="Product image" class="product-image">
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="{{ asset('product') }}">Butler Stool Ladder</a></h3><!-- End .product-title -->
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('/images/demos/demo-2/products/product-2-1.jpg') }}" alt="Product image" class="product-image">
                                        <img src="{{ asset('/images/demos/demo-2/products/product-2-2.jpg') }}" alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="{{ asset('product') }}">Octo 4240</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $746,00
                                    </div><!-- End .product-price -->
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{ asset('/images/demos/demo-2/products/product-3-1.jpg') }}" alt="Product image" class="product-image">
                                        <img src="{{ asset('/images/demos/demo-2/products/product-3-2.jpg') }}" alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="{{ asset('product') }}">Flow Slim Armchair</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $970,00
                                    </div><!-- End .product-price -->
                                </div><!-- End .product-body -->
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{ asset('/images/demos/demo-2/products/product-4-1.jpg') }}" alt="Product image" class="product-image">
                                        <img src="{{ asset('/images/demos/demo-2/products/product-4-2.jpg') }}" alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="{{ asset('product') }}">Roots Sofa Bed</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="{{ asset('product') }}">
                                        <img src="{{ asset('/images/demos/demo-2/products/product-5-1.jpg') }}" alt="Product image" class="product-image">
                                        <img src="{{ asset('/images/demos/demo-2/products/product-5-2.jpg') }}" alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="{{ asset('product') }}">Petite Table Lamp</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $675,00
                                    </div><!-- End .product-price -->
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="{{ asset('product') }}">
                                        <img src="{{ asset('/images/demos/demo-2/products/product-6-1.jpg') }}" alt="Product image" class="product-image">
                                        <img src="{{ asset('/images/demos/demo-2/products/product-6-2.jpg') }}" alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="{{ asset('product') }}">Elephant Armchair</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $457,00
                                    </div><!-- End .product-price -->
                                </div><!-- End .product-body -->
                    ...
                    <div class="tab-pane p-0 fade" id="trendy-decor-tab" role="tabpanel" aria-labelledby="trendy-decor-link">
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-11 text-center">
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="{{ asset('product.html') }}">Butler Stool Ladder</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $251,00
                                    </div><!-- End .product-price -->
                                </div><!-- End .product-body -->
            ...
            <div class="cta cta-display bg-image pt-4 pb-4" style="background-image: url({{asset('/images/backgrounds/cta/bg-6.jpg')}})">
                <div class="container">
                    <div class="row justify-content-center">

                                        ...
                                        <form action="{{ Route('auth.register.action') }}" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    ...
                                                    <select name="register_city" class="form-control"  required ></select>
            
                                                </div><!-- End .col-sm-6 -->
                                                <div class="col-sm-4">
                                                    <label>Distric / County *</label>
                                                    <select  name="register_district" class="form-control" required ></select>
                                                </div><!-- End .col-sm-6 -->
                                                <div class="col-sm-4">
            
                                                    <label>Ward / County *</label>
                                                    <select name="register_ward" class="form-control"  required ></select>
                                                </div><!-- End .col-sm-6 -->
                                            </div><!-- End .row -->

                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Dimension Table</h3>
            ...
            <div class="row ">
                <div class="col-md-12">
                    <form class="card card-danger">
                        <div class="card-header">
                            <h3 class="card-title">Add dimesion for products</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Width</label>
                                        <input type="number" min="10" name="product-price" class="form-control"
                                            step="10" value="0">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Height</label>
                                        <input type="number" min="10" name="product-quantity" class="form-control" step="10"
                                            value="0">
                                    </div>
                                </div>
                            </div>

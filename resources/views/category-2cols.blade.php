@extends('master')
@section('content')
    <input type="text" hidden name="column" value="2">
    <main class="main">
        <div class="page-header text-center" style="background-image: url('/images/page-header-bg.jpg')">
            <div class="container">
                <h1 class="page-title">Grid 2 Columns<span>Shop</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
                        ...
                        <div class="toolbox">
                            ...
                            <div class="toolbox-right">
                                ...
                                <div class="toolbox-layout">
                                    <a href="{{ route('category.2col') }}" class="btn-layout active">
                                    ...
                                    <a href="{{ route('category') }}" class="btn-layout ">

                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab-dashboard" role="tabpanel"
                                    ...
                                    <p>Hello <span class="font-weight-normal text-dark">{{$user->full_name}}</span> (not <span
                                            class="font-weight-normal text-dark">your account</span>? <a href="{{route('auth.logout.action')}}">Log out</a>)
                                        <br>
                                ...
                                <div class="tab-pane fade" id="tab-orders" role="tabpanel"
                                    ...
                                    <a href="{{route('category')}}" class="btn btn-outline-primary-2"><span>GO SHOP</span><i

                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="{{ asset('/images/products/product-13.jpg') }}" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="{{ asset('/images/products/product-13-thumb.jpg') }}" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="{{ asset('/images/products/product-13-2-thumb.jpg') }}" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="{{ asset('/images/products/product-14-thumb.jpg') }}" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="{{ asset('/images/products/product-14-2-thumb.jpg') }}" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="{{ asset('/images/products/product-14-3-thumb.jpg') }}" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="{{ asset('/images/products/product-15.jpg') }}" alt="Product image" class="product-image">
                                                </a>

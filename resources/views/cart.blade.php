                                ...
                                <tbody>
                                    ...
                                    @foreach ($cart as $item)
                                        <tr id="cart-item-{{ $item['product_id'] }}-{{ $item['color_id'] }}">
                                            ...
                                            <td class="total-col">{{ number_format($item['price'] * $item['quantity'], 0, '', '.') }}&nbsp;VNĐ</td>
                                ...
                                <table class="table table-summary">
                                    <tbody>
                                        <tr class="summary-subtotal">
                                            <td>Subtotal:</td>
                                            <td class="sub-total"> {{ number_format(App\Http\Controllers\CartController::totalPrice($cart), 0, '', ',')}}&nbsp;VNĐ</td>
                                        ...
                                        <tr class="summary-shipping-estimate">
                                            <td>Estimate for Your Country<br> <a href="{{ url('dashboard') }}">Change
                                                    address</a></td>
                                            <td>&nbsp;</td>

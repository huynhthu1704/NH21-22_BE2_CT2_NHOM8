...
class ProductController extends Controller
{
    ...
    function getTopProducts($cate_id)
    {
        ...
        $top_products = DB::table('products')->select('products.id as product_id', 'product_name', 'price',
         'products.sale_amount', 'src', 'colors.id as color_id', 'colors.color_name', 'colors.color_code', 'categories.category_name')
